...
(function() {
 ...
 gapi.loader.OBJECT_CREATE_TEST_OVERRIDE &&*/
    ...
    var Ea = function(a, b, c, d) {
            if (p[c + "EventListener"])
                p[c + "EventListener"](a, b, !1);
            else if (p[d + "tachEvent"])
                p[d + "tachEvent"]("on" + a, b)
        },
        Fa = function() {
            var a = t.readyState;
    ...
    H.push(["jsl", function(a) {
        ...
        if (b = a.u)
            a = v(F, "us", []), a.push(b), (b = /^https:(.*)$/.exec(b)) && a.push("http:" + b[1])
    }]);
    var Xa = /^(\/[a-zA-Z0-9_\-]+)+$/,
        Ya = [/\/amp\//, /\/amp$/, /^\/amp$/],
        Za = /^[a-zA-Z0-9\-_\.,!]+$/,
        ...
        fb = function(a) {
            ...
            c = 0;
            for (d = Ya.length; c < d; ++c)
                Ya[c].test(b) && J("invalid_prefix");
            c = ib(a, "k", !0);
            d = ib(a, "am");
            e = ib(a, "rs");
            a = ib(a, "t");
    ...
    var K = decodeURI("%73cript"),
        ...
        mb = function() {
            var a = F.nonce;
            if (void 0 !== a)
                return a && a === String(a) && a.match(kb) ? a : F.nonce = null;
            var b = v(F, "us", []);
            if (!b || !b.length)
                return F.nonce = null;
    ...
    var M = function(a) {
        ...
        O = function(a, b, c) {
            if (b && "object" === typeof b)
                for (var d in b)
                    !Object.prototype.hasOwnProperty.call(b, d) || c && "___goc" === d && "undefined" === typeof b[d] || (a[d] && b[d] && "object" === typeof a[d] && "object" === typeof b[d] && !tb(a[d]) && !tb(b[d]) ? O(a[d], b[d]) : b[d] && "object" ===
    ...
    var Pb,
        ...
        V = function(a, b) {
            ...
            if ("undefined" !== d) {
                ...
                "toJSON") || (e !== Vb || a.constructor !== Array && a.constructor !== Object) && (e !== Ub || a.constructor !== Array && a.constructor !== Object) && e !== Tb && e !== Qb && e !== Sb && e !== Rb))
                    return V(a.toJSON.call(a), c);
                if (null == a)
                    b[b.length] = "null";
                else if (e === Qb)
                    ...
                    if (e === Rb)
                        return V(a.toISOString.call(a), c);
        ...
        mc = function(a) {
            a = String(a);
            if (Wb.test(a) || Xb.test(a) || Yb.test(a) || Zb.test(a))
                return !1;
            var b = a.replace($b, '""');
            b = b.replace(ac, "0");
            b = b.replace(bc, "");
            ...
            b = b.replace(dc, "0");
            b = b.replace(ec, "0");
            if (fc.test(b) || gc.test(b) || hc.test(b) || ic.test(b) || !b || (b = b.replace(jc, "")))
                return !1;
        ...
        pc = function(a) {
            if (-1 !== R)
                return nc(), S ? m.JSON.stringify.call(m.JSON, a) : V(a)
        },
    ...
    var Kc = {
        ...
        Oc = function(a, b, c, d, e) {
            ...
            for (var k in c)
                a = c[k], "style" === k && "object" === typeof a ? z(a, f.style) : Lc[k] || f.setAttribute(k, String(a));
    ...
    var Uc = function(a) {
        ...
        Vc = function(a) {
            ...
            for (var b = document.getElementsByTagName("link"), c = 0, d = b.length; c < d; c++) {
                ...
                if (f && f.toLowerCase() == a && (e = e.getAttribute("href")) && (e = Uc(e)) && null != e.match(/^https?:\/\/[\w\-_\.]+/i))
                    return e
            }
    ...
    var Wc = {
        ...
        ad = function(a, b, c) {
            ...
            c = {};
            for (var l in f)
                x(f, l) && k.test(l) && (c[l.replace(k, "")] = f[l], delete f[l]);
            l = "q" == P("iframes/" + a + "/params/si") ? f :
            c;
            k = Cb();
            for (var q in k)
                !x(k, q) || x(f, q) || x(c, q) || (l[q] = k[q]);
            q = [].concat(Zc);
            (l = P("iframes/" + a + "/methods")) && "object" === typeof l && ha.test(l.push) && (q = q.concat(l));
            for (var n in b)
                x(b, n) && /^on/.test(n) && ("plus" != a || "onconnect" != n) && (q.push(n), delete f[n]);
            delete f.callback;
            c._methods = q.join(",");
            return za(e, f, c)
        },
    ...
    var pd = function(a, b) {
            ...
            case 1:
                if (b.parentNode) {
                    ...
                    if (c.rd)
                        ...
                        k = document.createElement("div"), b.setAttribute("data-gapistub", !0), k.style.cssText = "position:absolute;width:450px;left:-10000px;", b.parentNode.insertBefore(k, b);
                    g.siteElement =
                    k;
                    ...
                    b = c.ownerDocument || t;
                    k = 0;
                    do e = h.id || ["I", Mc++, "_", (new Date).getTime()].join("");
                    ...
                    if (k.forcePost || n && 2E3 < f.length) {
                        ...
                        for (n = 0; n < l.length; n++)
                            r = l[n].split("=", 2), h.push([decodeURIComponent(r[0]), decodeURIComponent(r[1])]);
                        k.query = [];
                        l = xa(k);
        ...
        ed = function(a, b) {
            ...
            if (d) {
                ...
                Fb("string" === "gapi." + c + ".render: missing element " + typeof a ? a : "")
        };
    v(B, "platform", {}).go = nd;
    od = function(a) {
            ...
            function d(d) {
                ...
                if (Dd(f, b)) {
                    ...
                    Ed(a, function() {
                        k && G("rqd");
                        c();
                        for (var a = v(F, "RPMQ", []), b = 0; b < a.length; b++)
                            a[b]({
                                data: f,
                                origin: h
                            })
        ...
        L("auth", {
            callback: function() {
                ...
                a.checkSessionState(e, function(b) {
                    ...
                    if (d = d != b)
                        xb("isLoggedIn", b), Hb(), fd(), b || ((b = a.signOut) ? b() : (b = a.setToken) && b(null));
                    b = Cb();
...
gapi.load("", {
    ...
    _c: {
        "jsl": {
            ...
            "h": "m;/_/scs/apps-static/_/js/k\u003doz.gapi.en_US.lyon4aDFbFk.O/m\u003d__features__/am\u003dAQ/rt\u003dj/d\u003d1/rs\u003dAGLTcCOKMiz7gIVCZ62llAJ83SLnLLBl4w",
            "u": "https://apis.google.com/js/platform.js?publisherid\u003d103752406404879322348",
            "hee": true,
