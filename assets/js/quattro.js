...
/*video preview*/
   ...
   $('.project-itemvideo').click(function(e) {
        e.preventDefault();
 ...
 function buildProjectvideo(elem) {
	document.getElementById('musicplay').onclick();
        ...
        for (var i = 0; i < slides.length; ++i) {
            slidesHtml = slidesHtml + '<li style="width:100%;"><iframe  src="http://player.vimeo.com/video/' + slides[i] + '"  width="95%" height="450" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe></li>';
        }
    ...
    function openProjectvideo() {
        ...
        setTimeout(function() {
            ...
            $('#project-slider').flexslider({
                prevText: '<img src="assets/images/lefta.png" style="float:left;">',
                nextText: '<img src="assets/images/righta.png" style="float:right;">',
                animation: 'slide',
    ...
    function openProject() {
        ...
        setTimeout(function() {
            ...
            $('#project-slider').flexslider({
                ...
                start: function() {
                    $(window).trigger('resize');
                    $('#project-preview').animate({'opacity': 1}, 900);
                }
            });
