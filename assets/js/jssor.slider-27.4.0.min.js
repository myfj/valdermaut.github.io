...
!function(i, h, m, e, d, k, f) {
    ...
    var b = i.$Jssor$ = new function() {
        ...
        function Gb() {
            if (!L) {
                ...
                if (x.pointerEnabled || (a = x.msPointerEnabled))
                    L.ne = a ? "msTouchAction" : "touchAction"
            }
            return L
        }
        function u(g) {
        ...
        j.Og = function(d, a) {
            if (a)
                d.style.clip = "rect(" + c.$Round(a.$Top || a.L || 0) + "px " + c.$Round(a.$Right) + "px " + c.$Round(a.$Bottom) + "px " + c.$Round(a.$Left || a.P || 0) + "px)";
            else if (a !== f) {
        ...
        j.Gg = function(b, a) {
            if (a)
                b.style.backgroundColor = "rgba(" + c.$Round(a.yd) + "," + c.$Round(a.Sd) + "," + c.$Round(a.Td) + "," + a.$Opacity + ")"
        };
        j.Cb = function() {
            return +new Date
        };
        ...
        function Ab(j, k, o) {
            ...
            d.$Scale = function(a, c, d) {
                if (a != 1 || c != 1 || d != 1)
                    b = f([a, 0, 0, 0, 0, c, 0, 0, 0, 0, d, 0, 0, 0, 0, 1])
            };
        ...
        j.ke = function(o, j, s, t, D, E, p) {
            ...
            if (a.$Clip && !a.$Clip.$Top && !a.$Clip.$Left && !a.$Clip.L && !a.$Clip.P && a.$Clip.$Right == p.$OriginalWidth && a.$Clip.$Bottom == p.$OriginalHeight)
                a.$Clip = e;
            return a
        }
    };
        ...
        s = i.$JssorSlideshowFormations$ = new function() {
            ...
            h.$FormationRandom = function(d) {
                for (var e = [], a, b = 0; b < d.$Rows; b++)
                    for (a = 0; a < d.$Cols; a++)
                        g(e, c.Q(1e5 * c.Nd()) % 13, [b, a]);
                return e
            };
            h.$FormationCircle = function(d) {
                for (var e = d.$Cols || 1, f = d.$Rows || 1, h = [], a, i = e / 2 - .5, j = f / 2 - .5, b = 0; b < e; b++)
                    for (a = 0; a < f; a++)
                        g(h, c.$Round(c.Pb(c.s(b - i, 2) + c.s(a - j, 2))), [a, b]);
                return h
            };
            h.$FormationCross = function(d) {
                for (var e = d.$Cols || 1, f = d.$Rows || 1, h = [], a, i = e / 2 - .5, j = f / 2 - .5, b = 0; b < e; b++)
                    for (a = 0; a < f; a++)
                        g(h, c.$Round(c.j(c.J(b - i), c.J(a - j))), [a, b]);
                return h
            };
            h.$FormationRectangleCross = function(f) {
                for (var h = f.$Cols || 1, i = f.$Rows || 1, j = [], a, d = h / 2 - .5, e = i / 2 - .5, k = c.m(d, e) + 1, b = 0; b < h; b++)
                    for (a = 0; a < i; a++)
                        g(j, c.$Round(k - c.m(d - c.J(b - d), e - c.J(a - e))) - 1, [a, b]);
                return j
            }
        };
                ...
                b.c(c, function(a, d) {
                    ...
                    if (c == "loading")
                        ...
                        if (a.tagName != "STYLE" && a.tagName != "SCRIPT")
                            mc[c || d] = new Rc(a, c == "slides", b.xe(["slides", "thumbnavigator"])[c])
                    }
                });
                R && b.sb(R);
                R = R || b.ac(h);
